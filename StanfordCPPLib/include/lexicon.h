...
private:
     ...
     */
	bool addHelper(TrieNode*& node, std::string word, const std::string& originalWord);
	...
	bool removeHelper(TrieNode*& node, std::string word, const std::string& originalWord, bool isPrefix);
